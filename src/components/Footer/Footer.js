    ...
    return(
        <footer className="footer pt-5 pb-5 text-center">
            ...
            <div className="container">
                ...
                <div className="socials-media">
                    ...
                    <ul className="list-unstyled">
                        <li className="d-inline-block ml-1 mr-1"><a href="#" className="text-dark">
            ...
            <a target="_blank" className="text-dark"
               href="https://www.wowthemes.net/pintereso-free-html-bootstrap-template/"><u>Pintereso Bootstrap HTML Template</u> by WowThemes.net.</a>
          </span>
                </p>
